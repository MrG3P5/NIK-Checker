...
class NikChecker:
    ...
    def Banner():
        ...
        say("Nik Checker", colors=["red", "green"], align="center")
        say("Created By X-MrG3P5", space=False, font="console", colors=["black"], background="red", align="center")
        print("")
    
    @staticmethod
    def Run():
        NikChecker.Banner()
        nikInput = input(f"{Fore.LIGHTCYAN_EX}[{Fore.LIGHTYELLOW_EX}#{Fore.LIGHTCYAN_EX}] {Fore.WHITE}Your NIK / NPWP --> ")
        print(f"{Fore.LIGHTCYAN_EX}[{Fore.LIGHTYELLOW_EX}#{Fore.LIGHTCYAN_EX}] {Fore.WHITE}Start Checking...")
        ...
        try:
            ...
            if data["Status"] == "true" and data["Server"][0]["Status_Server"] == "OK":
                if data["Data"]["status"] == 200:
                    print("")
                    print(f"{Fore.LIGHTCYAN_EX}[{Fore.LIGHTYELLOW_EX}#{Fore.LIGHTCYAN_EX}] {Fore.BLACK}{Back.LIGHTGREEN_EX}Data DiTemukan!")
